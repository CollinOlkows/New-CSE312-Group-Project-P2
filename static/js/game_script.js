...
function start_game(players,judge, user,img){
    ply = true
    if(judge == user){
        game_string = '<div id="prompt_div" class="GIPprompt"><h2 class="GIPpromptTitle">You are the judge. Please wait for all players to submit</h2></div><div class="GIPgameContainer"><div class="GIPscoreBoard"><h1>SCOREBOARD</h1><div class="GIPscoreBoardContainer">'
        ply = false
    }else{
    game_string = '<div id="prompt_div" class="GIPprompt"><h2 class="GIPpromptTitle">TYPE YOUR PROMPT BELOW</h2><textarea id="promptInput" class="GIPpromptForm" maxlength="300" placeholder="Prompt"></textarea><button class="GIPpromptSubmit" id="prompt_submit">SUBMIT YOUR PROMPT</button></div><div class="GIPgameContainer"><div class="GIPscoreBoard"><h1>SCOREBOARD</h1><div class="GIPscoreBoardContainer"><div id="user_list">'
    }
    let i = 0;
    ...
    game_string+='</div></div></div><div class="GIPjudge"><h1>JUDGING</h1><div class="GIPjudgeContainer"><h2 id="judge_name">CockusBallus</h2><img id="current_image" src="/static/images/lebronDuck.jpeg" class="GIPjudgeImg"></div></div></div>'
